...
// Woocommerce Setting
$wp_customize->add_section('section_woocommerce_setting', 
	array(    
	'title'       => __('Woocommerce Setting', 'prime-charity-trust'),
	'panel'       => 'theme_option_panel'    
	)
);

// Select No Of Columns
$wp_customize->add_setting( 'theme_options[prime_charity_trust_archive_product_per_row]', array(
	'default'           => $default['prime_charity_trust_archive_product_per_row'],
	'sanitize_callback' => 'prime_charity_trust_sanitize_select',
) );

$wp_customize->add_control( 'theme_options[prime_charity_trust_archive_product_per_row]', array(
	'label'              => esc_html__( 'Select No Of Columns', 'prime-charity-trust' ),
...
$wp_customize->add_setting( 
	'theme_options[prime_charity_trust_archive_product_per_page]', 
	array(
		'default'              => $default['prime_charity_trust_archive_product_per_page'],
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'prime_charity_trust_sanitize_number_absint',
...
$wp_customize->add_control( 
	'theme_options[prime_charity_trust_archive_product_per_page]',
    array(
		'label'       => esc_html__( 'Product Per Page','prime-charity-trust' ),
		'section'     => 'section_woocommerce_setting',
		'type'        => 'number',
    )
);
