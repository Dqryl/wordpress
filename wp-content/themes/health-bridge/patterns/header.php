...
/**
 * Title: HB Header
 * Slug: health-bridge/header
 * Categories: header
 */
?>
<!-- wp:group {"style":{"position":{"type":"sticky","top":"0px"},"spacing":{"padding":{"top":"2rem","bottom":"2rem","left":"1rem","right":"1rem"}}},"backgroundColor":"custom-hb-primary-dark","className":"hb-header","layout":{"type":"constrained"}} -->
<div class="wp-block-group hb-header has-custom-hb-primary-dark-background-color has-background" style="padding-top:2rem;padding-right:1rem;padding-bottom:2rem;padding-left:1rem"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"top":"1rem"}}}} -->
