 ...
 * Slug: health-bridge/template-index
...
<div class="wp-block-group"><!-- wp:query-title {"type":"archive","level":2,"style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-hb-primary"}}},"typography":{"textTransform":"capitalize","fontStyle":"normal","fontWeight":"500"}},"textColor":"custom-hb-primary","fontSize":"hb-xxl"} /--></div>
<!-- /wp:group -->
